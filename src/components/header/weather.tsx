...
export default function Weather() {
  ...
  return (
    <>
      {weatherData2 && (
        <div
          className={`flex h-full w-full basis-2/3 flex-col rounded-2xl font-black text-white sm:grid sm:grid-cols-2 sm:gap-5 md:gap-10 2xl:gap-10`}
        >
          <div
          ...
          >
            <div
              className={`my-5 w-24 justify-self-end sm:my-0 lg:w-32 2xl:w-40`}
            >
